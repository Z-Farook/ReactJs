...
import CounterController from './components/MemoryLeak/ToggleCounter';
import NoLeakCounter from './components/MemoryLeak/NoLeakCounter';
import ReactMemoExample from './components/ReactMemoComponent/ReactMemoExample';
...
function App() {
  ...
  return (
    ...
    {/* <CounterController/> */}
    {/* <ReactMemoExample firstName="Zahid"/> */}
